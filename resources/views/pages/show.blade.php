        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="top-comment"><!--top comment-->
                    <img src="{{$post->author->getAvatar()}}" class="pull-left img-circle" alt="" width="115">
                    ...
                    @foreach($post->getComments() as $comment)
                        <div class="bottom-comment"><!--bottom comment-->
                            ...
                            <div class="comment-img">
                                <img class="img-circle" src="{{$comment->author->getAvatar()}}" alt="" width="100" height="100">
                            </div>
